...
ActiveRecord::Schema.define(:version => 20120928053958) do
  ...
  create_table "departmentalizations", :force => true do |t|
  ...
  create_table "departments_institutions", :force => true do |t|
    t.integer "department_id"
